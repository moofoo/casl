...
const buildMongoQueryMatcher = (instructions, interpreters, options) => createFactory(Object.assign({}, defaultInstructions, instructions), Object.assign({}, defaultInterpreters, interpreters), options);
const mongoQueryMatcher = createFactory(defaultInstructions, defaultInterpreters);
